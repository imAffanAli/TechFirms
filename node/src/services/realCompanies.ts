...
const PK: RealSpec[] = [
  ...
  { name: 'CodeNinja', city: 'lahore', founded: 2014, emp: [300, 500], services: [{ slug: 'custom-software', focus: 40 }, { slug: 'web-development', focus: 30 }, { slug: 'mobile-app-development', focus: 30 }], domain: 'codeninja.pk', rate: [22, 50], minProject: 10000, certs: [], funding: 1600000, quality: 0.8 },
